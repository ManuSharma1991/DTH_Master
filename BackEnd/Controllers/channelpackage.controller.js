...
exports.create = (req, res) => {
    ...
    const channelpackage = new Channelpackage({
        ...
        channelpackageID: req.body.channelpackageID,
    });
...
exports.findOne = (req, res) => {
    console.log('line 51 ' + req.params.channelpackageId)

    Channelpackage.findOne({
            channelpackageID: req.params.channelpackageId
        })
        .then(channelpackage => {
            if (!channelpackage) {
                return res.status(404).send({
                    message: "Channelpackage not found with id" + req.params.channelpackageId
                });
            }
            ...
            return res.status(500).send({
                message: "Error retrieving channelpackage with id " + req.params.channelpackageId
            });
        });
};
...
exports.update = (req, res) => {
    ...
    Channelpackage.findOneAndUpdate({
        ...
        .then(channelpackage => {
            ...
            return res.status(500).send({
                message: "Error updating channelpackage with id " + req.params.channelpackageId
            });
        });
};
...
exports.delete = (req, res) => {
    Channelpackage.findOneAndDelete({
        ...
        .then(channelpackage => {
            ...
            return res.status(500).send({
                message: "Could not delete channelpackage with id " + req.params.channelpackageId
            });
        });
};